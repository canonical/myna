...
**Tests**: Test tasks are REQUIRED and MUST precede their corresponding implementation tasks (red-green TDD per constitution Principle I). Write each test, observe it fail, then implement.
...
- [ ] TXXX Performance watermark baselines + regression tolerances (constitution Principle III)
...
|---|--------|------------------------|-----------------------|-------------|
| 1 | [e.g., 00X-foo-foundation] | Phase 1–2 | — | hermetic suite |
| 2 | [e.g., 00X-foo-us1] | Phase 3 (US1) | #1 | hermetic + integration |
