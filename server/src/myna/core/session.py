...
This stays a flat config, not IE115's nested
``session.audio.input.transcription`` envelope —
...
(the client signals end-of-audio explicitly), not server VAD. The wire
