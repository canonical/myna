...
- **FR-017a** **(Removed: `com.canonical.Myna.Shell` presence name is no longer exposed. Fallback suppression now uses the `RegisterClient` client set on `com.canonical.Myna.Dictation` — see `contracts/dbus-interface.md` C14/C15.)**
