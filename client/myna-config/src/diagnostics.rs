...
/// snapshot. This covers `snap info`, at most four prioritized modelctl
/// candidate probes, and the three modelctl data commands.
pub const BACKEND_REFRESH_PROCESS_BUDGET: usize = 8;
